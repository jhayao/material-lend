...
<section class="section-py first-section-pt help-center-header position-relative overflow-hidden">
  <img class="banner-bg-img scaleX-n1-rtl" src="{{asset('assets/img/pages/header-'.$configData['style'].'.png')}}" alt="Help center header" data-app-light-img="pages/header-light.png" data-app-dark-img="pages/header-dark.png"/>
